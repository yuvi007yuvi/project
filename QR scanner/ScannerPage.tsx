  ...
  const handleScanSuccess = (result: string) => {
    ...
    try {
      ...
      if (uploadIndex !== -1 && pathParts[uploadIndex + 1]) {
        ...
        alert('Invalid QR code. Please scan a valid municipal photo system QR code.');
      }
    } catch (error) {
      ...
      if (qrCodeMatch) {
        ...
        alert('Invalid QR code format. Please scan a valid municipal photo system QR code.');
      }
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Scan QR codes to upload before and after photos for municipal documentation
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h4 className="text-lg font-semibold text-gray-900">Mobile Optimized</h4>
            </div>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h4 className="text-lg font-semibold text-gray-900">No App Required</h4>
            </div>
            <p className="text-gray-600">
